...
-- CreateEnum
CREATE TYPE "InventoryMovementType" AS ENUM ('SALE', 'RESTOCK', 'CANCEL', 'ADJUSTMENT');

-- CreateEnum
CREATE TYPE "RiskFlag" AS ENUM ('NORMAL', 'WATCH', 'BLOCKED');
...
CREATE TABLE "CustomerRiskProfile" (
    ...
    "customerCancelCount" INTEGER NOT NULL DEFAULT 0,
    "codAbandonCount" INTEGER NOT NULL DEFAULT 0,
    "riskScore" INTEGER NOT NULL DEFAULT 100,
    "manualFlag" "RiskFlag" NOT NULL DEFAULT 'NORMAL',
    "sellerNote" TEXT,
    "lastOrderAt" TIMESTAMP(3),
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "CustomerRiskProfile_pkey" PRIMARY KEY ("userId")
);
